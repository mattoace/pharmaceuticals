...
class BannersController extends CI_Controller {
 ...
 public function displayImages(){
    ...
    $list = $this->banners->getImageList($drugId);
    $i = 1;
...
public function fetchFiles(){
        ...
        $list = $this->banners->fetchFiles($this->input->get("id"));
        $data = array();
        $no = $_POST['start'];
        foreach ($list as $obj) {
            $no++;
...
public function viewFile(){
      ...
      $list = $this->banners->fetchFile($this->input->get("id"));
...
class ImgUploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $fulpth = $this->get_full_url().'/assets/uploads/banners/banners_'.$selectedrugId.'';
        ...
        $this->options = array(
            ...
            'script_url' => 'banners-imgupload',
            //'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/',
            'upload_dir' =>'assets/uploads/banners/banners_'.$selectedrugId.'/',
            'upload_url' => $fulpth,
