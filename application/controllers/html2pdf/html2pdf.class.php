...
'.$content.'
        ...
        protected function _tag_open_OPTION($param)
        {
            ...
            $selected = (isset($param['selected']) && $param['selected']=='selected');
            
            $this->_lstSelect['selected'] = $param['value'];
        ...
        protected function _tag_close_SELECT()
        {
            ...
            $script = "getField('".$this->_lstSelect['name']."').value= '".$this->_lstSelect['options'][0]."';";
