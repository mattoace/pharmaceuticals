...
class Settings extends CI_Model { 
    ...
    var $table = 'smtp';
    var $column_order = array(null, 'id','host','port','username','pass','default','defaultemail'); //set column field database for datatable orderable
    var $column_search = array('id','host','port','username','pass','default','defaultemail'); //set column field database for datatable searchable 
   ...
   function get_datatables()
    ...
    public function saveRecord($arrObject,$id){        
      $this->db->where('id',$id);
      $this->db->update('smtp',$arrObject);
    } 

   public function fetchRecord($id){

        $this->db->select('id,host,port,username,pass,default as def,defaultemail');
        $this->db->from('smtp');
        $this->db->where('id',$id);
        $query = $this->db->get();
       return $query->result();
