...
<link rel="stylesheet" href='<?php echo base_url("assets/css/upload.css");?>'>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Pharmacy system generated orders
      </h1>
      <ol class="breadcrumb">
         ...
         <!--      <li><a href="#timeline" data-toggle="tab">Drug categories</a></li>
            ...
            <div class="tab-content">
              ...
              <div class="user-block">
                    ...
                    <div class="btn-group">
                      <button type="button" onClick = "sendorderconfirmation()" class="btn btn-danger">Send Order Confirmation Note</button>
                      <button type="button" onClick = "cOrders()" class="btn btn-danger">Confirmed Orders</button>           
                    </div>
        ...
        <!-- Fade & scale -->
            ...
            <div id="dialogpopupimage" class="well" style="visibility:hidden;">   
             ...
             <div id="confirmationpopup" class="well" style="visibility:hidden;width:50%;height: 70%; overflow-x: hidden;overflow-y: auto;background-color:#ECF0F5;">
               <div class="row"> 
                    <div class="btn-group">
                      <button type="button" id="confirmingselected" onClick = "confirmSelected()" class="btn btn-danger">Confirm Selected</button>
                      <button type="button" id="changequantity" onClick = "changeQuantityOfSelected(this)" class="btn btn-danger">Change Quantity</button> 
                      <br><hr>                             
                    </div>
              ...
              <div id="popchngeqty" class="well" style="visibility:hidden;width:20%;height: 20%; overflow-x: hidden;overflow-y: auto;background-color:#A8CEE2;">
               <div class="row"> 
                    <div class="col-md-12" style="background-color:#DFF0D8"> 
                        <div class="form-group">
                          <label for="categoryname">Change Quantity of Order</label>
                          <input type="input" class="form-control" id="changeqty" placeholder="New Quantity">                     
                        </div>  
               
                </div>
             </div>
                   <div class="btn-group">
                      <button type="button" id="changingqty" onClick = "saveQuantityChange()" class="btn btn-danger">Change</button>                                                 
                    </div>
