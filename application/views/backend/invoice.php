        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">Patient Invoices</a></li>
         <!--      <li><a href="#timeline" data-toggle="tab">Drug categories</a></li>
            ...
            <div class="tab-content">
              ...
              <div class="user-block">
                    ...
                    <div class="btn-group">
                      <button type="button" id="confirmingselected" onClick = "sendInvoice()" class="btn btn-danger">Resend Invoice</button>
                      <button type="button" id="generatepdf" onClick = "generatePDF()" class="btn btn-danger">View Invoice PDF</button>                                
                    </div>
