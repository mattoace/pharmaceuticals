        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">Pharmacy suppliers</a></li>              
            </ul>
            <div class="tab-content">
              ...
              <div class="user-block">
                ...
                <div id="dialogpopup" class="well" style="visibility:hidden;">
                   <div id ="popupheading" > <h4>Add a new supplier</h4> </div>
                            ...
                            <form role="form">
                              <div class="box-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="email" class="form-control" id="firstname" placeholder="Company Name">
                                </div>
                                ...
                                <div class="form-group">
                                  <label for="secondname">Contact First Name</label>
                                  <input type="input" class="form-control" id="secondname" placeholder="Contact First Name">
                                </div>

                                <div class="form-group">
                                  <label for="surname">Contact Second Name</label>
                                  <input type="input" class="form-control" id="surname" placeholder="Contact Second Name">
                                </div>
                ...
                <div class="post clearfix">
                  <div class="user-block">
                    ...
                    <span class="description">Form view of selected supplier</span>
                  </div>
                  <!-- /.user-block -->
                          ...
                          <div class="box box-primary"> 
                            ...
                            <form role="form">
                              <div class="box-body">
                                ...
                                <div class="form-group">
                                  <label for="firstname">Company Name</label>
                                  <input type="email" class="form-control" id="firstname1" placeholder="Company Name">
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="input" class="form-control" id="secondname1" placeholder="First Name">
                                </div>

                                <div class="form-group">
                                  <label for="surname">Second Name</label>
                                  <input type="input" class="form-control" id="surname1" placeholder="Second Name">
                                </div>
