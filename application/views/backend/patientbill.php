  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Patient Bills</li>
      </ol>
    </section>
...
<div class="col-md-3">
  ...
  <h2 class="username">Bill Total:</h2>
       ...
       <div class="box box-primary">            
            <!-- /.box-header -->
            <div class="box-body">
              <strong><i class="fa fa-money margin-r-5"></i>Accomulated bill</strong>
              <p class="text-muted">              
                 <textarea class="textareas" id="totals" name="totals" placeholder="Total bill of the selected patient" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
            ...
            <script src="<?php echo base_url('assets/plugins/datatables/extensions/Select/dataTables.select.min.js')?>"></script> 
        		...
        		<script src="<?php echo base_url('assets/js/patientbill.js')?>"></script> 
                </div>
                <!-- /.post -->
                ...
                <div class="post clearfix">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src='<?php echo base_url("assets/img/prescription1.jpg");?>' alt="">
                        <span class="username">
                          <a href="#">Patient's bill</a>
                        </span>
                    <span class="description">Display all the selected patients bills in order</span>
                  </div>
                    ...
                    <div class="col-md-6">
                            ...
                            <form role="form">
                              <div class="box-body">
                                ...
                                <div class="form-group">
                                  <label for="initial">Order Id/ Order No.</label>
                                  <input type="input" class="form-control" id="orderid" placeholder="Order Number">
                                  <input type="hidden" class="form-control" id="oid" placeholder="1">
                                </div>

                                <div class="form-group">
                                  <label for="firstname">Billing date</label>
                                  <input type="input" class="form-control" id="billingdate" placeholder="Billing date">
                                </div>
                                <div class="form-group">
                                  <label for="secondname">Amount</label>
                                  <input type="input" class="form-control" id="amount" placeholder="Bill amount">
                                </div>
