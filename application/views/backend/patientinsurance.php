        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            ...
            <script src="<?php echo base_url('assets/plugins/datatables/extensions/Select/dataTables.select.min.js')?>"></script> 
        		...
        		<script src="<?php echo base_url('assets/js/patientinsurance.js')?>"></script> 
                </div>
                <!-- /.post -->
                ...
                <div class="post clearfix">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src='<?php echo base_url("assets/img/prescription1.jpg");?>' alt="">
                        <span class="username">
                          <a href="#">Patients Insurance Details</a>
                        </span>
                    <span class="description">Below is the list of companies the patient has insured with.</span>
                  </div>
                     ...
                     <div class="col-md-6">
                            ...
                            <form role="form">
                              <div class="box-body">
                                ...
                                <div class="form-group">
                                  <label for="initial">Insurance Company</label>
                                  <input type="input" class="form-control" id="inscompanyname" placeholder="Enter company Insured with">
                                  <input type="hidden" class="form-control" id="insu_id" placeholder="1">
                                </div>
                                ...
                                <div class="form-group">
                                  <label for="secondname">Address</label>
                                  <input type="input" class="form-control" id="address" placeholder="Insurance company address">
                                </div>

                                <div class="form-group">
                                  <label for="surname">Member Number</label>
                                  <input type="input" class="form-control" id="memberno" placeholder="Member Number">
                                </div> 
