        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">Clinics subscribed</a></li>
           <!--    <li><a href="#timeline" data-toggle="tab">Contact person</a></li>
              <li><a href="#settings" data-toggle="tab">Additional details</a></li> -->
                ...
                <div id="dialogpopup" class="well" style="visibility:hidden;">
                   <div id ="popupheading" > <h4>Add a new Clinic</h4> </div>
                            ...
                            <form role="form">
                              <div class="box-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="input" class="form-control" id="clinicname" placeholder="Clinic Name">
                ...
                <script src="<?php echo base_url('assets/js/clinics.js')?>"></script> 
                </div>
                <!-- /.post -->
                ...
                <div class="post clearfix">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src='<?php echo base_url("assets/img/clinic1.jpg");?>' alt="">
                        <span class="username">
                          <a href="#">Clinic details</a>
                          <a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
                        </span>
                    <span class="description">Information</span>
                  </div>
                  <!-- /.user-block -->
                        <p><input class="form-control input-sm" placeholder="Clinic Name">
                        <p><input class="form-control input-sm" placeholder="Address">
                        <p><input class="form-control input-sm" placeholder="Location">
                        <p><input class="form-control input-sm" placeholder="Nearest Town">
                ...
                <div class="post">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src='<?php echo base_url("assets/img/clinic2.jpg");?>' alt="">
                        <span class="username">
                          <a href="#">Clinic images upload</a>
                          <a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
                        </span>
                 ...
                 <div class="row margin-bottom">
                    <div class="col-sm-6">
                      <img class="img-responsive" id="pharmacyholder" style="width:100%; height:20%;" src='<?php echo base_url("assets/img/clinic4.jpg");?>' alt=""><br>
                      <div class="col-sm-3">
                    ...
                    <div class="col-sm-6">
                      <div class="row">
                            ...
                            <fieldset class="gllpLatlonPicker" >
                                ...
                                <div class="gllpMap" style="width:92% !important;height:305px !important;">Google Maps</div>
