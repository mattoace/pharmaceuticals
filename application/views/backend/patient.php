          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
             ...
             <a href="#" class="" onClick="changePersonImage()"> <p class="text-muted text-center" id="changeimg">Change image</p>
              ...
              <a href="patientrefill" class="btn btn-primary btn-block"><b>View Patient Prescription</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">Registered patients</a></li>              
            </ul>
                ...
                <div class="post clearfix">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src='<?php echo base_url("assets/img/patient1.jpg");?>' alt="">
                        <span class="username">
                          <a href="#">Patients details</a>
                          <a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
                        </span>
                    <span class="description">Form view of selected patient</span>
                  </div>
                  <!-- /.user-block -->
