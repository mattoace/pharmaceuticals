        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">Registered Users</a></li>
                            ...
                            <form role="form">
                              <div class="box-body">
                                ...
                                <div class="form-group">
                                  <label for="clinicname">Full Names</label>
                                  <input type="input" class="form-control" id="fullnames" placeholder="Enter full names">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="input" class="form-control" id="phone" placeholder="Location">
                                </div>

                                <div class="form-group">
                                  <label for="town">Password</label>
                                  <input type="password" class="form-control" id="pass" placeholder="Nearest town">
                                </div>


                                <div class="form-group" syle="width:10% !important;">
                                  <label for="town">Is Admin</label>
                                  <input type="checkbox" class="form-controls" id="isadmin" placeholder="" syle="width:10% !important;">
                                </div> 


                               <div class="form-group" syle="width:10% !important;">
                                  <label for="town">Is Active</label>
                                  <input type="checkbox" class="form-controls" id="isactive" placeholder="" syle="width:10%; !important">
                                </div> 
        ...
        <div class="col-md-3">  
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <a href="#" class="" onClick="changePersonImage()"> <p class="text-muted text-center" id="changeimg"></p>
