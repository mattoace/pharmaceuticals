...
<link rel="stylesheet" href='<?php echo base_url("assets/plugins/jsgrid-1.5.3/dist/jsgrid.min.css");?>'>
<link rel="stylesheet" href='<?php echo base_url("assets/plugins/jsgrid-1.5.3/dist/jsgrid-theme.min.css");?>'>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Presccription</a></li>
        <li class="active">Presccription Uploads</li>
      </ol>
    </section>
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="activity">
                ...
                <script src="<?php echo base_url('assets/plugins/jsgrid-1.5.3/dist/jsgrid.js')?>"></script> 
                <script src="<?php echo base_url('assets/js/prescriptionuploads.js')?>"></script> 
                </div>
                <!-- /.post -->
                ...
                <div class="post clearfix">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src='<?php echo base_url("assets/img/prescription1.jpg");?>' alt="">
                        <span class="username">
                          <a href="#">Uploaded Prescriptions</a>
                        </span>
                    <span class="description">View prescriptions uploaded by the patient</span>
                  </div>
                  ...
                  <div class="user-block">
                    <div class="btn-group">
                      <button type="button" onClick = "viewUploadedDocument()" class="btn btn-danger">View Document Uploaded</button>
                    </div>
                ...
                <div class="user-block">
                    <div class="btn-group">
                      <button type="button" onClick = "savePatientUploads()" class="btn btn-danger">Save Remarks</button>
                      <button type="button" onClick = "orderMedication()" class="btn btn-danger">Order Medication</button>
                    </div>
                            ...
                            <form role="form">
                              <div class="box-body">
                                ...
                                <div class="form-group">
                                    <textarea class="textarea" id="doctorscomments" name="doctorscomments" placeholder="Doctors Comments" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                  <input type="hidden" class="form-control" id="pupload_id" placeholder="1">
                                </div>
  ...
  <!-- /.content-wrapper -->
            ...
            <div id="uploadpopup" class="well" style="visibility:hidden;">
             ...
             <div id="medicationspopup" class="well" style="visibility:hidden;width:50%;height: 70%; overflow-x: hidden;overflow-y: auto;background-color:#ECF0F5;">  
              ...
              <div class="col-md-6"> 
                 <button type="button" onClick="executeOrder()" style="margin-top:10%;float:right;" class="btn btn-danger">Order Selected Medication(s)</button>
              </div>
              </div>
                   <div class="col-md-12"> 

                      <table id="medicationtable" class="cdataTable" cellspacing="0" width="100%" >
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                                <th></th>
              ...
              <div id="confirmorderspopup" class="well" style="visibility:hidden;width:80%;height: auto; overflow-x: hidden;overflow-y: auto;background-color:#ECF0F5;">
                 <span class="username">
                      <div class="col-md-12"> 
                        <div class="col-md-6"> 
                        <h4>Change/Edit Quantity</h4>
                        </div>
                        <div class="col-md-6"> 
                        <button type="button" onClick="confirmOrder()" style="float:right;" class="btn btn-danger">Confirm the Order</button>
                        </div>
                        </div>
