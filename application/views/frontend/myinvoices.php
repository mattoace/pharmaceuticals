        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">Invoices</a></li>          
            </ul>
            <div class="tab-content">
              <div class="active tab-pane" id="activity">
                ...
                <div class="post">
                  ...
                  <!-- /.user-block -->
                    <table id="invoicetabletable" class="cDatatable" cellspacing="0" width="100%" style="line-height:none !important;">
                                    <thead>
                                        <tr>
                                            <th>Id</th>
                                            <th>Inv.Date</th>
...
<script src='<?php echo base_url("assets/js/front/myinvoices.js");?>'></script>
