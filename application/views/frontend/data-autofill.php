        ...
        <p>
            <h6>Refill your medication or order for our products.</h6><br>
              ...
              $drugid = $_GET['id'];  
                 ...
                 $category = ($row[0]->categoryid?$row[0]->categoryid:1); 
                 ...
                 <div class="camera_wrap camera_azure_skin" id="camera_wrap_1"> 
                   ...
                   $queryimg = $this->db->query("SELECT * FROM bannerimages WHERE parent = '".$category."'");
                    ...
                    if($rowimg ){
                          ...
                          print('<div data-thumb="assets/img/m1.jpg" data-src='.$row[0]->catimg.'><div class="camera_caption fadeFromBottom">Search Results</div></div><br>');
