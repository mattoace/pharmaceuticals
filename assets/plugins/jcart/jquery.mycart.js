...
(function ($) {
  ...
  var OptionManager = (function () {
    ...
    var defaultOptions = {
      ...
      classCouponCode : 'my-product-couponcode',
  ...
  var ProductManager = (function(){
    ...
    */
    ...
    var addProduct = function(id, name, summary, price, quantity, image ,couponcode) {
      var products = getAllProducts();
      products.push({
        id: id,
        name: name,
    ...
    */
    ...
    var setProduct = function(id, name, summary, price, quantity, image ,couponcode) {
      ...
      if(!updatePoduct(id)){
        addProduct(id, name, summary, price, quantity, image ,couponcode);
      }
    }
  ...
  var loadMyCartEvent = function(userOptions){
    ...
    var classCouponCode = options.classCouponCode;
    ...
    if(!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<div class="modal-footer"> <label for="dosename" class="mylabels" style="float:left;">Gift / Coupon(s) &nbsp;</label><input type="text" class="form-control" style="width:20%;float:left;height: 21px;font-size: 9px;" id="couponcode" placeholder="Enter Coupon Code"></div>' +
    ...
    var drawTable = function(){
      ...
      $.each(products, function(){
        ...
        $cartTable.append(
          ...
          '<td>' + this.name + '</td>' +
          '<td title="Unit Price"><span style="">' + this.price + '/=</span></td>' +
          '<td title="Quantity"><input type="number" min="1" style="width: 70px;" class="' + classProductQuantity + '" value="' + this.quantity + '"/></td>' +
  
          '<td title="Total" class="' + classProductTotal + '"><span style="">' + total + '/=</span></td>' +

          //'<td title="Coupon"><input type="text" class="'+classCouponCode+'" style="width:100%;float:left;height: 25px;font-size: 9px;" id="couponcode" placeholder="Coupon"></td>' +
  ...
  var MyCart = function (target, userOptions) {
    ...
    */
    $target.click(function(){
      ...
      var couponcode = $target.data('couponcode');
      var image = $target.data('image');

      ProductManager.setProduct(id, name, summary, price, quantity, image ,couponcode);
      $cartBadge.text(ProductManager.getTotalQuantity());
    });
