...
$(document).ready( function() {
	if (!$.gMapsLatLonPickerNoAutoInit) {
		...
		locationObject = $obj = $(document).gMapsLatLonPicker();		
			$obj.init( $(this) );
...
$(document).bind("location_changed", function(event, object) {
	...
	updateLatLng($(this),object);
});

function updateLatLng(object,obj) { 
    var lat = $(object).find('.gllpLatitude').val(); 
    var lng = $(object).find('.gllpLongitude').val();
    var latLng = lat + ',' + lng; 
   
    $("#latlong").html("<b><i>Current latitude ~  Latitude : " + lat + ", Longitude " +  lng +"</i></b>");
   // alert("New Lat" + lat + ", New Longitude " +  lng );
